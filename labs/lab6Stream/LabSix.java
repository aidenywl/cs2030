...
public class LabSix {
  ...
  public static void main(String[] args) {
    ...
    BusStop src = new BusStop(args[0]); // creating the first stop.
    String name = args[1]; // the destination you want to go to.
    Instant start = Instant.now();
    BusSg.findBusServicesBetween(src, name) // find the bus services between src and destination.
