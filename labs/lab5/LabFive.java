...
class LabFive {
  public static void main(String[] args) {
    ...
    if (!match) {
      System.out.println("ERROR: matrix multiplicaton gives inconsistent " +
          "result when multiplying sequentially and parallelly.");
      return;
    }

    double d1 = measureTimeToRun(() -> Matrix.multiplyNonRecursively(matrixOne, matrixTwo));
