...
public class PriorityQueue<T> {
  ...
  private PriorityQueue(PriorityQueue<T> source1, PriorityQueue<T> source2) {
    this.pq = new java.util.PriorityQueue<T>();
    this.pq.addAll(source1.pq);
    this.pq.addAll(source2.pq);
  }
  ...
  /**
   * Adds all objects from another priorityQueue into this priority Queue.
   * @param  otherPQ the other priorityQueue
   * @return        a new priorityQueue containing the combined priorityQueue.
   */
  public PriorityQueue<T> addAll(PriorityQueue<T> otherPQ) {
    return new PriorityQueue<T>(this, otherPQ);
  }
